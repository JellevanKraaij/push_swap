...
void	rotate_a(t_vars *vars)
{
	...
	ft_lstadd_front(&vars->instruc, null_exit(ft_lstnew(ROTATE_A)));
}

void	rotate_b(t_vars *vars)
{
	vars->stack_b = vars->stack_b->next;
	ft_lstadd_front(&vars->instruc, null_exit(ft_lstnew(ROTATE_B)));
}
...
void	rotate_ab(t_vars *vars)
{
	vars->stack_a = vars->stack_a->next;
	vars->stack_b = vars->stack_b->next;
	ft_lstadd_front(&vars->instruc, null_exit(ft_lstnew(ROTATE_AB)));
}
